  ...
  useEffect(() => {
    ...
    lineChart.current = new Chart(lineRef.current, {
      ...
      data: {
        labels: MONTHS,
        datasets: [
          { label: '2023', data: electricity[2023], borderColor: '#7EC8C8', backgroundColor: 'rgba(126,200,200,0.1)', tension: 0.4, fill: true, pointRadius: 4, borderWidth: 2.5 },
          { label: '2022', data: electricity[2022], borderColor: '#A8C5DA', backgroundColor: 'transparent', tension: 0.4, pointRadius: 3, borderDash: [5,3], borderWidth: 2 },
          { label: '2021', data: electricity[2021], borderColor: '#C9DCE8', backgroundColor: 'transparent', tension: 0.4, pointRadius: 3, borderDash: [3,4], borderWidth: 1.5 },
        ],
      },
      options: {
