  ...
  useEffect(() => {
    ...
    scopeChart.current = new Chart(scopeRef.current, {
      ...
      data: {
        labels: YEARS,
        datasets: [
          { label: 'Scope 2 (электричество)', data: emissions.scope2, backgroundColor: 'rgba(168,197,218,0.8)', borderRadius: 6 },
          { label: 'Scope 1 (газ/тепло)',     data: emissions.scope1, backgroundColor: 'rgba(126,200,200,0.8)', borderRadius: 6 },
        ],
      },
      options: {
      ...
      <div style={card}>
        <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: 16 }}>
          ...
          <div style={{ display: 'flex', gap: 12 }}>
            {[
              { color: 'rgba(168,197,218,0.8)', label: 'Scope 2' },
              { color: 'rgba(126,200,200,0.8)', label: 'Scope 1' },
            ].map(s => (
